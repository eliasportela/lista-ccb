                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-8 text-center">
                            <div class="row">
                                <div class="col-sm-6">
                                    <img class="img-responsive img-circle" src="<?=base_url('assets/img/users/'.$user->img_perfil)?>">
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#contato">Alterar Foto</button>
                                </div>
